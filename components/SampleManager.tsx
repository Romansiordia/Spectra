...
const SampleManager: React.FC<SampleManagerProps> = ({ samples, onToggle, onToggleAll }) => {
    ...
    return (
        <Card noPadding>
             <div className="bg-ui-dark px-6 py-4 border-b border-ui-border flex justify-between items-center">
                            ...
                            <div key={sample.id} className="flex items-center justify-between rounded-md group">
                                <div className="flex items-center gap-3 overflow-hidden">
                                    <input
                                        ...
                                        className="w-4 h-4 rounded border-slate-300 text-ui-accent focus:ring-brand-500 cursor-pointer flex-shrink-0"
                                    />
